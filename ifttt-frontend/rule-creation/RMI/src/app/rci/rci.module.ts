...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'selectCapability/:device_id',
        component: CapabilitySelectorComponent
      },
      {
        path: 'selectDevice/:zone_id',
...
@NgModule({
  imports: [
    ...
    BrowserAnimationsModule, ColorPickerModule, MatFormFieldModule, 
    MatTabsModule
  ],
  declarations: [
    RcibaseComponent, RuleCreatorComponent, ChannelSelectorComponent,
    DeviceSelectorComponent, CapabilitySelectorComponent, 
    ParameterConfigurationComponent, ZoneSelectorComponent
  ],
